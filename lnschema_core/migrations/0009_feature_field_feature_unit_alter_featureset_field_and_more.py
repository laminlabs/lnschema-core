...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL("insert into lnschema_core_file_feature_sets (id, file_id, feature_set_id) select id, file_id, feature_set_id from lnschema_core_feature_set_files"),
