...
def upgrade() -> None:
    ...
    if bind.engine.name == "sqlite":
        ...
        op.execute("alter table public.user rename to lnschema_core_user")
        op.execute("alter table public.project rename to lnschema_core_project")
        op.execute("alter table public.storage rename to lnschema_core_storage")
        op.execute("alter table public.transform rename to lnschema_core_transform")
        op.execute("alter table public.run rename to lnschema_core_run")
        op.execute("alter table public.file rename to lnschema_core_file")
        op.execute("alter table public.folder rename to lnschema_core_folder")
        op.execute("alter table public.features rename to lnschema_core_features")
        op.execute("alter table public.run_in rename to lnschema_core_runinput")
        op.execute("alter table public.file_features rename to lnschema_core_filefeatures")
        op.execute("alter table public.project_folder rename to lnschema_core_projectfolder")
        op.execute("alter table public.folder_file rename to lnschema_core_folderfile")
