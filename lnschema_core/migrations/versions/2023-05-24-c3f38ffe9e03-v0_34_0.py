...
def upgrade() -> None:
    ...
    if bind.engine.name == "sqlite":
        ...
        op.rename_table(old_table_name="user", new_table_name="lnschema_core_user")
        op.rename_table(old_table_name="project", new_table_name="lnschema_core_project")
        op.rename_table(old_table_name="storage", new_table_name="lnschema_core_storage")
        op.rename_table(old_table_name="transform", new_table_name="lnschema_core_transform")
        op.rename_table(old_table_name="run", new_table_name="lnschema_core_run")
        op.rename_table(old_table_name="file", new_table_name="lnschema_core_file")
        op.rename_table(old_table_name="folder", new_table_name="lnschema_core_folder")
