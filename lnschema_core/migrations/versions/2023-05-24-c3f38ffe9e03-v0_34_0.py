...
def upgrade() -> None:
    ...
    if bind.engine.name == "sqlite":
        ...
        op.execute("alter table user rename to lnschema_core_user")
        op.execute("alter table project rename to lnschema_core_project")
        op.execute("alter table storage rename to lnschema_core_storage")
        op.execute("alter table transform rename to lnschema_core_transform")
        op.execute("alter table run rename to lnschema_core_run")
        op.execute("alter table file rename to lnschema_core_file")
        op.execute("alter table folder rename to lnschema_core_folder")
        op.execute("alter table features rename to lnschema_core_features")
        op.execute("alter table run_in rename to lnschema_core_runinput")
        op.execute("alter table file_features rename to lnschema_core_filefeatures")
        op.execute("alter table project_folder rename to lnschema_core_projectfolder")
        op.execute("alter table folder_file rename to lnschema_core_folderfile")
