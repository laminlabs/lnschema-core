...
def upgrade() -> None:
    ...
    if bind.engine.name == "sqlite":
        ...
        op.execute("alter table core.run set schema public rename")
        op.execute("alter table core.file set schema public rename")
        op.execute("alter table core.folder set schema public rename")
        op.execute("alter table core.features set schema public rename")
        op.execute("alter table core.run_in set schema public rename")
