# Generated by Django 4.2.1 on 2023-06-10 13:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "suffix",
                    models.CharField(db_index=True, default=None, max_length=30, null=True),
                ),
                ("size", models.BigIntegerField(db_index=True, null=True)),
                (
                    "hash",
                    models.CharField(db_index=True, default=None, max_length=86, null=True),
                ),
                (
                    "key",
                    models.CharField(db_index=True, default=None, max_length=255, null=True),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(default=None, max_length=8, primary_key=True, serialize=False),
                ),
                (
                    "handle",
                    models.CharField(db_index=True, default=None, max_length=30, unique=True),
                ),
                (
                    "email",
                    models.CharField(db_index=True, default=None, max_length=255, unique=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "region",
                    models.CharField(db_index=True, default=None, max_length=63, null=True),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, db_index=True)),
                ("updated_at", models.DateTimeField(auto_now=True, db_index=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(default=None, max_length=64, primary_key=True, serialize=False),
                ),
                ...
                (
                    "files",
                    models.ManyToManyField(related_name="featuresets", to="lnschema_core.file"),
                ),
            ],
            options={
                "managed": True,
