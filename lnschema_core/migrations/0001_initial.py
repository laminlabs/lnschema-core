...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=None, max_length=8, primary_key=True, serialize=False
                    ),
                ),
                (
                    "handle",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "region",
                    models.CharField(
                        db_index=True, default=None, max_length=63, null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, db_index=True)),
                ("updated_at", models.DateTimeField(auto_now=True, db_index=True)),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="projects", to="lnschema_core.file"
                    ),
                ),
                (
                    "folders",
                    models.ManyToManyField(
                        related_name="projects", to="lnschema_core.folder"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="files",
            field=models.ManyToManyField(
                related_name="folders", to="lnschema_core.file"
            ),
        ),
        migrations.AddField(
            model_name="folder",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=None, max_length=64, primary_key=True, serialize=False
                    ),
                ),
                ...
                (
                    "files",
                    models.ManyToManyField(
                        related_name="featuresets", to="lnschema_core.file"
                    ),
                ),
            ],
        ),
