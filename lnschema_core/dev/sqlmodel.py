...
def get_prefix_schema_delim_from_alembic() -> Tuple[str, Optional[str], str]:
...
def _resolve_forward_ref(ann, module):
    ...
    if len(resolved_args) == 1:
        ...
        # Union-like types (e.g. typing.Union[str, ForwardRef("lamindb.schema._core.Pipeline")])
