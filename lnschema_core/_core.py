...
from sqlmodel import Field, ForeignKeyConstraint, Relationship, UniqueConstraint
...
class Storage(SQLModel, table=True):  # type: ignore
    ...
    """Base62 char ID, generated by :func:`~lnschema_core.dev.id.storage`."""
...
class DObject(SQLModel, table=True):  # type: ignore
    ...
    __table_args__ = (UniqueConstraint("storage_id", "_objectkey", "suffix", name="uq_storage__objectkey_suffix"),)

    id: str = Field(default_factory=idg.dobject, primary_key=True)
    """Base62 char ID, generated by :func:`~lnschema_core.dev.id.dobject`."""
    name: Optional[str] = Field(index=True)
...
class Notebook(SQLModel, table=True):  # type: ignore
    ...
    """Base62 char ID & primary key, generated by :func:`~lnschema_core.dev.id.notebook`."""  # noqa
...
class Usage(SQLModel, table=True):  # type: ignore
    ...
    """Base62 char ID & primary key, generated by :func:`~lnschema_core.dev.id.usage`."""  # noqa
