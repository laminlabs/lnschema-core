...
--- | --- | --- | --- | ---
🐛 Fix clashing reverse accessors between `.previous_runs` and `.run` | [391](https://github.com/laminlabs/lnschema-core/pull/391) | [falexwolf](https://github.com/falexwolf) | 2024-06-13 |
